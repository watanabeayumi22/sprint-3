...
import { LocalAudioStream, LocalPersonImpl, LocalVideoStream, Publication, PublicationImpl, SkyWayChannelImpl, SkyWayConnection, SkyWayContext, Subscription, SubscriptionImpl } from '@skyway-sdk/core';
...
export declare class SFUConnection implements SkyWayConnection {
    ...
    /**@internal */
    addSender(publication: PublicationImpl<LocalVideoStream | LocalAudioStream>): Sender;
    /**@internal */
