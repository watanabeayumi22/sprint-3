...
import { LocalAudioStream, LocalPersonImpl, LocalVideoStream, MemberImpl, MemberType, Publication, RemoteMemberImplInterface, SkyWayChannelImpl, SkyWayContext } from '@skyway-sdk/core';
...
export declare class SfuBotMember extends MemberImpl implements RemoteMemberImplInterface {
     ...
     */
    startForwarding(publication: Publication<LocalVideoStream | LocalAudioStream>, configure?: Partial<ForwardingConfigure>): Promise<Forwarding>;
