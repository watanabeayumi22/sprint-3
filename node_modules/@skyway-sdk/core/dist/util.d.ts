...
/**@internal */
export declare const waitForLocalStats: (stream: LocalStream, remoteMember: string, end: (stats: WebRTCStats) => boolean, interval?: number, timeout?: number) => Promise<WebRTCStats>;
/**@internal */
