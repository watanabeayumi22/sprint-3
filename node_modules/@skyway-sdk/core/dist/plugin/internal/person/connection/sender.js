...
class Sender extends peer_1.Peer {
    constructor(context, iceManager, signaling, localPerson, endpoint) {
        ...
        this.restartIce = () => __awaiter(this, void 0, void 0, function* () {
            if (this._backoffIceRestarted.exceeded) {
                this._log.error((0, util_3.createError)({
            ...
            this._log.warn('[start] restartIce', (0, util_3.createWarnPayload)({
                operationName: 'Sender.restartIce',
            ...
            const checkNeedEnd = () => {
                if (this.endpoint.state === 'left') {
                    this._log.warn('endpointMemberLeft', (0, util_3.createWarnPayload)({
                ...
                if (this.pc.connectionState === 'connected') {
                    this._log.warn('[end] restartIce', (0, util_3.createWarnPayload)({
                        operationName: 'restartIce',
                        detail: 'reconnected',
                        channel: this.localPerson.channel,
                        payload: { count: this._backoffIceRestarted.count },
            ...
            if (e) {
                this._log.warn('[failed] restartIce', (0, util_3.createWarnPayload)({
                    operationName: 'restartIce',
            ...
            if (this.signaling.connectionState !== 'connected') {
                this._log.warn('<restartIce> reconnect signaling service', (0, util_3.createWarnPayload)({
                    operationName: 'restartIce',
            ...
            e = yield this.signaling
                ...
                .catch((e) => e);
            if (e) {
                this._log.warn('<restartIce> [failed]', (0, util_3.createWarnPayload)({
                    operationName: 'restartIce',
    ...
    _listenStreamEnableChange(stream, publicationId) {
        ...
        const { removeListener } = stream._onEnableChanged.add((track) => __awaiter(this, void 0, void 0, function* () {
            yield this._replaceTrack(publicationId, track).catch((e) => {
                log.warn((0, util_3.createWarnPayload)({
    ...
    _setupTransportAccessForStream(stream) {
        ...
        stream._getStatsCallbacks[this.endpoint.id] = () => __awaiter(this, void 0, void 0, function* () {
            if (stream.contentType === 'data') {
                ...
                const arr = (0, util_3.statsToArray)(stats);
                return arr;
            }
    ...
    remove(publicationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!publication) {
                this._log.warn('<remove> publication not found', (0, util_3.createWarnPayload)({
    ...
    _replaceTrack(publicationId, track) {
        return __awaiter(this, void 0, void 0, function* () {
            const transceiver = this.transceivers[publicationId];
            if (!transceiver) {
                this._log.warn("can't replace track, transceiver not found", (0, util_3.createWarnPayload)({
    ...
    _handleReceiverAnswer({ sdp, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.pc
                ...
                .catch((err) => {
                const error = (0, util_3.createError)({
...
function applyCodecCapabilities(codecCapabilities, mid, sdpObject) {
    ...
    const findCodecFromCodecCapability = (cap, rtp, fmtp) => {
        var _a;
        const rtpList = rtp.map((r) => (Object.assign(Object.assign({}, r), { parameters: (0, util_3.getParameters)(fmtp, r.payload) })));
